...
class Order(models.Model):
    ...
    order_status = models.ForeignKey(StatusCrm, on_delete=models.PROTECT, null=True, blank=False, verbose_name='Статус')
...
class ComentCrm(models.Model):
    ...
    coment_dt = models.DateField(auto_now=True, verbose_name='Дата создания')
